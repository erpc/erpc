...
---
description: open-source fault-tolerant evm rpc proxy and cache
---
...
Create your [`erpc.yaml`](/config/example) configuration file based on the `erpc.yaml.dist` file:
