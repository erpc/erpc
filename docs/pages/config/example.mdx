...
<Callout type="info">
  A single instance of eRPC can server multiple projects (frontend, indexer, etc) and multiple networks and chains.
</Callout>
...
projects:
 - id: main
   ...
   - endpoint: https://eth-mainnet.g.alchemy.com/v2/xxxxx
...
- [ ] More advanced validation for the values to prevent
user errors.
- [ ] Add healthcheck configuration for error rate, and max allowed
