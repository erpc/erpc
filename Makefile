...
test-fallback-config:
	@go clean -testcache
	@go test ./erpc -run 'TestPolicyEvaluator/DefaultPolicy|TestNetworkForward_TryAllUpstreams_FallbackWithinSameRound|TestHandleEthCallBatchAggregation_FallbackPaths' -count=1
