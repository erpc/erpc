...
type jsUpstream struct {
	...
	// Tags is the user-applied label set. Stdlib tag methods (`byTag`,
	// `preferTag`, `spreadAcrossTags`) read this directly. Convention:
	// entries are either bare strings or `prefix:value`.
