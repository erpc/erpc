...
**Note**: If you are using a github URL, you can simply use the shorthand of `superchain://github.com/org/repo/chainList.json`. if your url includes `blob`, t will be automatically stripped.
