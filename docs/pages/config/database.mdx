...
The cache system recognizes three empty states:

- `ignore`: Ignore empty responses (default) and do not cache them
- `allow`: Cache empty responses
- `only`: Only cache empty responses
