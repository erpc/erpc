        ...
        failsafe:
          - matchMethod: "*"
            ...
            hedge:
              delay: 500ms
              maxCount: 1
            # circuitBreaker is upstream-scope only — see upstreams.failsafe below.
      - architecture: evm
        evm:
          chainId: 42161
        failsafe:
        ...
        failsafe:
          - matchMethod: "*"
            ...
            retry:
              ...
              backoffFactor: 1.2
              jitter: 0ms
            # Per-upstream circuit breaker — opens on 80% failure rate over the
            # last 200 reqs, probes every 5m, closes on 3 consecutive successes.
            circuitBreaker:
