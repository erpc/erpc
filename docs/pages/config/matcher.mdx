...
description: Pattern matching DSL used wherever eRPC compares network/method/param/header values — supports wildcards, OR/AND/NOT, and numeric comparisons over hex/decimal.
---
