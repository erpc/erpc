...
func main() {
	...
	serverConfigs := []test.ServerConfig{
		{Port: 8081, FailureRate: 0.1, LimitedRate: 0.005, MinDelay: 50 * time.Millisecond, MaxDelay: 200 * time.Millisecond, SampleFile: "test/samples/evm-json-rpc.json"},
		{Port: 8082, FailureRate: 0.3, LimitedRate: 0.2, MinDelay: 100 * time.Millisecond, MaxDelay: 300 * time.Millisecond, SampleFile: "test/samples/evm-json-rpc.json"},
		{Port: 8083, FailureRate: 0.05, LimitedRate: 0.01, MinDelay: 30 * time.Millisecond, MaxDelay: 150 * time.Millisecond, SampleFile: "test/samples/evm-json-rpc.json"},
	}
