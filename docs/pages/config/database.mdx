---
description: Long-term storage is optional but used for various purposes such as caching, rate limit persistence, etc...
---
...
export default createConfig({
  database: {
    evmJsonRpcCache: {
      // Possible drivers: "memory", "redis", "postgresql", "dynamodb"
      driver: "memory", // Replace "memory" with your desired driver
      // ... (driver specific config, see below)
    },
  },
});
    ...
    evmJsonRpcCache: {
      ...
      dynamodb: {
        ...
        auth: {
          ...
          accessKeyId: "YOUR_ACCESS_KEY_ID", // Only if mode is secret
          secretAccessKey: "YOUR_SECRET_ACCESS_KEY", // Only if mode is secret
          profile: "xxxx", // Only if mode is file
          credentialsFile: "xxxx", // Only if mode is file
        }
      },
    },
