...
<br />
- [ ] Support a Typescript-based config to allow injecting env variables and code reusability.
- [ ] More advanced validation for the values to prevent user errors.
- [ ] Add healthcheck configuration for error rate, and max allowed blocked behind allowed for evm upstreams.
