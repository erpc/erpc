...
- [`superchain`](#superchain) Accepts superchain registry json file and automatically adds all chains from the [Optimism Superchain Registry](https://github.com/ethereum-optimism/superchain-registry)
...
projects:
  - id: main
    # ...
    upstreams:
      - endpoint: superchain://github.com/ethereum-optimism/superchain-registry
        # ...
```
</Tabs.Tab>
  <Tabs.Tab>
...
providers:
  ...
  - vendor: superchain
    settings:
      apiKey: public
      registryUrl: https://github.com/ethereum-optimism/superchain-registry
