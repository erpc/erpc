...
type SupportedPlatform = 'darwin_x86_64' | 'darwin_arm64' | 'linux_x86_64' | 'linux_arm64' | 'windows_x86_64';
...
export function getPlatform(): SupportedPlatform {
  ...
  throw new Error(`Unsupported platform: ${type} ${arch}. Please file an issue at [your-repo-url]`);
}
