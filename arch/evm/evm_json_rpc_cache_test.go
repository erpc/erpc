...
// func createCacheTestFixtures(upstreamConfigs []upsTestCfg) ([]*data.MockConnector, []*upstream.Upstream, *EvmJsonRpcCache) {
// 	logger := log.Logger
...
// 	return []*data.MockConnector{mockConnector1, mockConnector2}, upstreams, cache
// }

// func TestEvmJsonRpcCache_Set(t *testing.T) {
// 	t.Run("DoNotCacheWhenEthGetTransactionByHashMissingBlockNumber", func(t *testing.T) {
// 		mockConnectors, mockUpstreams, cache := createCacheTestFixtures([]upsTestCfg{{id: "upsA", syncing: common.EvmSyncingStateUnknown, finBn: 10, lstBn: 15}})
...
// 		mockConnectors, mockUpstreams, cache := createCacheTestFixtures([]upsTestCfg{{id: "upsA", syncing: common.EvmSyncingStateSyncing, finBn: 10, lstBn: 15}})
...
// 		mockConnectors, mockUpstreams, cache := createCacheTestFixtures([]upsTestCfg{{id: "upsA", syncing: common.EvmSyncingStateNotSyncing, finBn: 10, lstBn: 15}})
...
// 		mockConnectors, mockUpstreams, cache := createCacheTestFixtures([]upsTestCfg{
...
// 		mockConnectors, _, cache := createCacheTestFixtures([]upsTestCfg{{id: "upsA", syncing: common.EvmSyncingStateUnknown, finBn: 10, lstBn: 15}})
...
// 		mockConnectors, _, cache := createCacheTestFixtures([]upsTestCfg{
