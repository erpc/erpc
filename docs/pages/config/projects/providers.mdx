...
- [`superchain`](#superchain) Accepts superchain registry json file (e.g [github.com/ethereum-optimism/superchain-registry](https://github.com/ethereum-optimism/superchain-registry)) and automatically adds all chains from it.
...
This provider accepts superchain registry json file (e.g [github.com/ethereum-optimism/superchain-registry](https://github.com/ethereum-optimism/superchain-registry)) and automatically adds all chains from it.
