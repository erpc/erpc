...
- <Callout type='info'>
  ...
  availability simply helps skip over such nodes faster without trying them first.<br />
...
- updateRate: 0 freezes the computed bound; >0 periodically re-evaluates it
        ...
        evm:
          ...
          blockAvailability:
            upper:
              ...
              updateRate: 0s               # 0 = compute once per process lifetime
        ...
        evm:
          blockAvailability:
            lower:
              ...
              updateRate: 0s
            upper:
              latestBlockMinus: 128        # rolling upper bound
              probe: blockHeader
        ...
        },
        {
          ...
          evm: {
            blockAvailability: {
              ...
              upper: { latestBlockMinus: 128, probe: "blockHeader" },
            },
          },
        },
        {
