...
func TestHttpJsonRpcClient_SingleRequests(t *testing.T) {
	...
	t.Run("TimeoutError", func(t *testing.T) {
		...
		client, err := NewGenericHttpJsonRpcClient(ctx, &logger, "prj1", ups, &url.URL{Scheme: "http", Host: "rpc1.localhost:8545"}, ups.Config().JsonRpc, nil, nil)
...
func TestHttpJsonRpcClient_BatchRequests(t *testing.T) {
	...
	t.Run("SimpleBatchRequest", func(t *testing.T) {
		...
		ups.Config().Type = common.UpstreamTypeEvm
		ups.Config().Endpoint = "http://rpc1.localhost:8545"
		client, err := NewGenericHttpJsonRpcClient(ctx, &logger, "prj1", ups, &url.URL{Scheme: "http", Host: "rpc1.localhost:8545"}, &common.JsonRpcUpstreamConfig{
