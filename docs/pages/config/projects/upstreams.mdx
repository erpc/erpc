  ...
  - id: hot
    ...
    routing:
      scoreMultipliers:
        - network: "*"
          method: "*"
          errorRate: 8            # overrides BALANCED.errorRate
          respLatency: 12         # overrides BALANCED.respLatency
