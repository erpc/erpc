...
projects:
  - id: main
    ...
    upstreams:
      # (REQUIRED) Endpoint URL supports http(s) and ws(s) schemes, along with custom schemes like "alchemy://" defined below in this docs.
      # Use ws:// or wss:// for WebSocket upstreams (required for eth_subscribe support).
  ...
  projects: [
    {
      ...
      upstreams: [
        ...
        {
          // Supports http(s) and ws(s) schemes. Use ws:// or wss:// for WebSocket upstreams (required for eth_subscribe).
          endpoint: "https://arbitrum-one.blastapi.io/xxxxxxx-xxxxxx-xxxxxxx",
