...
- [`tenderly`](#tenderly) Accepts tenderly api key and automatically adds all their EVM chains.
- [`onfinality`](#onfinality) Accepts onfinality api key and automatically adds all their EVM chains.
- [`conduit`](#conduit) Accepts conduit.xyz api key and automatically adds all their EVM chains.
- [`superchain`](#superchain) Accepts superchain registry json file (e.g [github.com/ethereum-optimism/superchain-registry/main/chainList.json](https://github.com/ethereum-optimism/superchain-registry/blob/main/chainList.json)) and automatically adds all chains from it.
