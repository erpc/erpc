...
Built for [Conduit](https://conduit.xyz/) 3rd-party provider to make it easier to import all their supported EVM chains with just an API key.
...
providers:
  ...
  - vendor: conduit
    settings:
      apiKey: xxxxx
      recheckInterval: 24h # How often to recheck the API for newly added networks (default: 24h)
```
