...
projects:
 - id: main
   ...
   - endpoint: evm+alchemy://xxxx-my-alchemy-api-key-xxxx # Add all supported Alchemy chains
   - endpoint: evm+envio://rpc.hypersync.xyz # Add all supported methods and chains of Envio's HyperRPC
```
