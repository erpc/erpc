...
- **Block head lag** gives higher priority to upstreams with lower block head lag (compared to best upstream).
- **Finalization lag** gives higher priority to upstreams with lower finalization lag (compared to best upstream).
