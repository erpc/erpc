...
<Callout type='info'>
  eRPC team has published an IPFS file containing public endpoints from [chainlist.org](https://chainlist.org), [chainid.network](https://chainid.network) and [viem library](https://viem.sh), which is pointed to by [https://evm-public-endpoints.erpc.cloud](https://evm-public-endpoints.erpc.cloud) domain.
</Callout>
