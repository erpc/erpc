...
- [`repository`](#repository) A special provider where it automatically adds "public and free" RPC endpoints automatically for all EVM chains.
...
<Callout type='info'>
  eRPC team regularly updates an IPFS file containing public endpoints from [chainlist.org](https://chainlist.org), [chainid.network](https://chainid.network) and [viem library](https://viem.sh), which is pointed to by [https://evm-public-endpoints.erpc.cloud](https://evm-public-endpoints.erpc.cloud) domain.
</Callout>
